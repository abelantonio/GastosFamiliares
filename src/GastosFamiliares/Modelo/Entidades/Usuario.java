...
public class Usuario implements Serializable{
   ...
   // Constructores con parametros
    public Usuario(String codigo, String nombre, String apellido, RolUsuarioEnum rol) {
        this.codigo = codigo;
        this.nombre = nombre;
   ...
   public Usuario(String codigo, String password, String nombre, String apellido, String correo, RolUsuarioEnum rol){
      this.codigo = codigo;
